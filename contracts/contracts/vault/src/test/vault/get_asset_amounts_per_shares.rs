...
use crate::test::vinifica_vault::{AssetStrategySet, ContractError, RolesDataKey, Instruction};
use crate::test::{
...
fn deposit_several_assets_get_asset_amounts_per_shares() {
    ...
    let result1 = vinifica_contract.get_asset_amounts_per_shares(&0i128);
    let result2 = vinifica_contract.get_asset_amounts_per_shares(&1000i128);
    let result3 = vinifica_contract.get_asset_amounts_per_shares(&2000i128);
    let result4 = vinifica_contract.get_asset_amounts_per_shares(&3000i128);
    let result5 = vinifica_contract.get_asset_amounts_per_shares(&4000i128);
    let result6 = vinifica_contract.get_asset_amounts_per_shares(&5000i128);
    ...
    let result7 = vinifica_contract.try_get_asset_amounts_per_shares(&1111111111i128);
...
fn deposit_and_invest_several_assets_get_asset_amounts_per_shares() {
    ...
    let token_0_invested_funds = vinifica_contract.fetch_total_managed_funds().get(0).unwrap().invested_amount;
    let token_1_invested_funds = vinifica_contract.fetch_total_managed_funds().get(1).unwrap().invested_amount;
    let token_0_idle_funds = test.token_0.balance(&vinifica_contract.address);
    let token_1_idle_funds = test.token_1.balance(&vinifica_contract.address);
