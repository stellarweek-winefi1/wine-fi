...
use crate::vault::vinifica_vault_contract::VaultContractClient;
...
pub fn create_vault_one_asset_hodl_strategy<'a>() -> VaultOneAseetHodlStrategy<'a> {
    ...
    let vault_contract_address = setup.factory_contract.create_vinifica_vault(
        &roles,
        &vault_fee,
        &assets,
...
mod tests {
    ...
    fn test_create_vault_one_asset_hodl_strategy() {
        ...
        assert_eq!(vault_name, String::from_str(&setup.env, "vinifica-Vault-HodlVault"));
    ...
    fn test_create_vault_one_asset_fixed_strategy() {
        ...
        let vault_name = enviroment.vault_contract.name();
        assert_eq!(vault_name, String::from_str(&setup.env, "vinifica-Vault-FixedVault"));
    ...
    fn test_create_vault_blend_strategy() {
        ...
        let vault_name = enviroment.vault_contract.name();
        assert_eq!(vault_name, String::from_str(&setup.env, "vinifica-Vault-BlendVault"));
