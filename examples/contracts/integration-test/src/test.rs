extern crate std;
use crate::factory::vinificaFactoryClient;
use soroban_sdk::{
...
use crate::vault::vinifica_vault_contract;

pub static ONE_YEAR_IN_SECONDS: u64 = 31_536_000;
pub static vinifica_FEE: u32 = 50;
pub static DAY_IN_LEDGERS: u32 = 17280;

pub struct IntegrationTest<'a> {
    pub env: Env,
    pub factory_contract: vinificaFactoryClient<'a>,
    pub admin: Address,
    pub vinifica_receiver: Address,
    pub vinifica_fee: u32,
}
