# vinifica Contracts
To use this application use the vinifica Docker container by running:
 ``` bash
...
## Deploying a vault
Deploying a **vinifica** vault requires careful configuration. Follow these steps precisely:"
...
## Generate Docs
```bash
cargo doc --package vinifica-strategy-core --package vinifica-factory --package vinifica-vault --no-deps
```
