...
interface NetworkConfig {
  ...
  blend_keeper: string;
  vinifica_factory_admin: string;
  vinifica_fee_receiver: string;
  vinifica_fee: string;
...
export class EnvConfig {
  ...
  admin: Keypair;
  blendKeeper: string;
  vinificaFeeReceiver: string;
  vinificaFactoryAdmin: string;
  vinificaFee: string;
  ...
  constructor(
    ...
    this.vinificaFeeReceiver = vinificaFeeReceiver;
    this.vinificaFactoryAdmin = vinificaFactoryAdmin;
    this.vinificaFee = vinificaFee;
  ...
  static loadFromFile(network: string): EnvConfig {
    ...
    let rpc_url, horizon_rpc_url, friendbot_url, passphrase, blendKeeper, vinificaFeeReceiver, vinificaFactoryAdmin, vinificaFee, vaultFeeReceiver, vaultManager;
    ...
    const config_fields: string[] = [
      ...
      "blend_keeper",
      "vinifica_fee_receiver",
      "vinifica_factory_admin",
      "vinifica_fee",
      "vault_fee_receiver",
      "vault_manager",
    ...
    vinificaFeeReceiver = networkConfig.vinifica_fee_receiver;
    vinificaFactoryAdmin = networkConfig.vinifica_factory_admin;
    vinificaFee = networkConfig.vinifica_fee;
