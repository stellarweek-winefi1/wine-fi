...
export const feeReceiver = Keypair.fromPublicKey(loadedConfig.vinificaFeeReceiver);
...
/**
 * Generates the parameters required to create a vinifica vault.
 *
 ...
 */
export function getCreatevinificaParams(
...
export async function deployVault(
  ...
  try {
    ...
    console.log(
      "🚀 « vinifica Vault created with address:",
