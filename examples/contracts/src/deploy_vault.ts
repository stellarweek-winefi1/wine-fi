...
export async function deployVault(
  ...
  const createvinificaParams: xdr.ScVal[] = getCreatevinificaParams(
    ...
    Keypair.fromPublicKey(loadedConfig.vinificaFeeReceiver), //Fee receiver
...
async function deployvinificaVault() {
...
const deployResult = await deployvinificaVault();
